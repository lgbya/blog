...
return [
    ...
    */
    ...
    |
    */
    'bootstrap' => app_path('Http/Controllers/Admin/bootstrap.php'),
    ...
    */
    'auth' => [
        ...
        'controller' => App\Http\Controllers\Admin\Controllers\AuthController::class,
        ...
        'editormd' => [
            ...
            'config' =>
                [
                    ...
                    'imageUploadURL' => "/admin/upload-file",
                ],
